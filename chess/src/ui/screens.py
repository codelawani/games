...
class LoadPrevious(Screen):
	...
	def compose(self) -> ComposeResult:
		...
		yield Grid(
			Static("A previous game was found. Would you like to continue it?", id="question"),
...
class QuitGame(Screen):
	...
	def compose(self) -> ComposeResult:
		...
		yield Grid(
			Static("You're about to quit this game, your progress can be saved?", id="question"),
...
class Welcome(Screen):
	...
	def compose(self) -> ComposeResult:
		...
		yield Grid(
			...
			Input(value="White", id="input1", placeholder="Enter Player 1's name"),
			Input(value="Black", id="input2", placeholder="Enter Player 2's name"),
			Container(Button("Start Game", variant="primary", id="start"), id="start-container"),
			id="welcome"
		)
...
class PawnPromotion(Screen):
	...
	def compose(self) -> ComposeResult:
		...
		with Grid(id="dialog"):
			yield Static("Choose a piece to promote your pawn to", id="question")
			with Horizontal():
